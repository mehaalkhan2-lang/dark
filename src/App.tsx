  ...
  useEffect(() => {
    ...
    const unsubSignals = onSnapshot(q, (snapshot) => {
      ...
      if (err.message.includes("index")) {
        setError("Database indexing in progress. Please wait a few minutes for the signals feed to activate.");
        setSignals([]);
      } else if (err.message.includes("permission")) {
        console.warn("Signals sync waiting for permissions...");
        setSignals([]);
      } else {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#050505]">
        <div className="animate-spin text-white"><Zap size={48} /></div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4 text-xs font-mono">
            <div className="flex items-center gap-1.5 text-red-500 uppercase tracking-widest border-r border-white/10 pr-4">
              <UserIcon size={14} />
              <span className="font-bold">1005</span>
            </div>
        ...
        {!user && (
          ...
          >
            ...
            <h3 className="text-lg font-bold mb-2 uppercase tracking-wider">Welcome to Dark</h3>
            <p className="text-gray-400 text-sm mb-0">
              Viewing in observer mode. Login for personalized alerts and features.
            </p>
          </motion.div>
        )}
      ...
      <footer className="max-w-5xl mx-auto px-4 py-12 border-t border-white/5 text-center text-gray-600 text-xs font-mono uppercase tracking-[0.2em]">
        &copy; {new Date().getFullYear()} Dark Trading. All rights reserved.
      </footer>
